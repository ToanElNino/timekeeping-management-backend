                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#766fca; border-radius:5px; margin-left:auto; margin-right:auto;">
                        <tr>
                            <td align="center" valign="middle" style="color:#FFFFFF; font-family:Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold; padding-top:15px; padding-bottom:15px;">
                                <a href="` +
    url +
    `" target="_blank" style="color:#FFFFFF; text-decoration:none; padding: 19px 45px;">Reset password</a>
                            </td>
                        </tr>
                    </table>
    ...
    <body>
        <div style='min-height: max-content;'>
            <div class="container">                   
                <p style='line-height: 40px;width: 100%;text-align: center; background-color: #EEEEEE; margin: 0;'>*** This is an automatically generated email, please do not reply ***</p>
                <div style='padding: 2% 15% 2% 15%; background-color: #fff; color: #000 !important;'>
                    <h1 style='text-align: center;'>Your account has been ` +
    statusHeader +
    `.</h1>
                    <p>Dear ${request.username}</p>
                    <p>We would like to inform you that your account has been ` +
    status +
    ` on our platfrom.</p>    
                    <p>Reason: ${data.reason}</p>
                    <p>Please reach out to ` +
    url +
    ` should you have any enquiry.</p>
                    <p>Thank you,</p>
                    <p>Var Meta Team</p>
                </div> 
            </div>
...
export function updateStatusOfCollection(
  request,
  data,
  url,
  status,
        ...
        <div style='min-height: max-content;'>
            <div class="container">                   
                ...
                <div style='padding: 2% 15% 2% 15%; background-color: #fff; color: #000 !important;'>
                    ...
                    <p>Dear ${request.username}</p>
                    <p>We would like to inform you that your listing has been ` +
    status +
    ` on our platfrom.</p> 
                    <p>` +
    linkCollection +
        ...
        <div style='min-height: max-content;'>
            <div class="container">                   
                ...
                <div style='padding: 2% 15% 2% 15%; background-color: #fff; color: #000 !important;'>
                    ...
                    <p>Dear ${request.username}</p>
                    <p>We would like to inform you that your game has been ` +
    status +
    ` on our platfrom.</p> 
                    <p>` +
    linkGame +
        ...
        <div style='min-height: max-content;'>
            <div class="container">                   
                ...
                <div style='padding: 2% 15% 2% 15%; background-color: #fff; color: #000 !important;'>
                    ...
                    <p>Dear ${request.username}</p>
                    <p>We would like to inform you that your token has been ` +
    status +
    ` on our platfrom.</p> 
                    <p>` +
    linkToken +
